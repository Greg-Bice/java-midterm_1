...
public abstract class Person implements java.io.Serializable {
			...
			Date DOB, String Address, String Phone_number, String Email) throws PersonException
	{
		...
		if ( age > 100 ) {
			...
			throw new PersonException( this, "DOB given is more than 100 years older than the current date." );
		...
		if ( !matcher.matches() ) {
			...
			throw new PersonException( this, "Phone number is not properly formatted to (###) ###-####" );
